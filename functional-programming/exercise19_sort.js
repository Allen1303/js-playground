"use strict"
/**
 @param Return a Sorted Array Without Changing the Original Array
...
@param Task Use the sort method in the nonMutatingSort function to sort the elements of an array in ascending order.
...
function nonMutatingSort(arr) {
  // Solution Code
  const newArr = arr.concat([]).slice(0).sort((a, b) => a - b);
  return newArr;
