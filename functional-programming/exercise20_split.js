"use strict"
/**
@param Split a String into an Array Using the split Method
...
@param Here are two examples that split one string by spaces, then another by digits using a regular expression:
...
@param bySpace would have the value ["Hello", "World"] and byDigits would have the value ["How", "are", "you", "today"].

 * @param Task: Use the split method inside the splitify function to split str into an array of words.
