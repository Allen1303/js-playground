"use strict";
/**
 *@param Use the every Method to Check that Every Element in an Array Meets a Criteria
...
@param example, the following code would check if every element in the numbers array is less than 10:
