"use strict";
/**
 @param Filter Matching Obj Properties
 Mmake a function that looks through an array of objects (first argument) and returns an array of all objects
...
@param example, if the first argument is [{ first: "Romeo", last: "Montague" }, { first: "Mercutio", last: null }, { first: "Tybalt", last: "Capulet" }],
 ...
 * */
const filterMatchingProp = (collection, source) => {
  const matchingProp = collection.filter((obj) =>
